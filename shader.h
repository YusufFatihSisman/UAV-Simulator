...
public:
    ...
    void setMat4(const std::string &name, glm::mat4 matrice)
    {
        glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, glm::value_ptr(matrice));
    }
    ...
    void setVec3(const std::string &name, float value0, float value1, float value2)
    {
